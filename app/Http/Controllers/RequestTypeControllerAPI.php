...
class RequestTypeControllerAPI extends Controller
{
    // GET ALL TYPES
    public function getAllTypes(Request $request)
    {
        if($request->ajax())
        {
            ...
            return datatables($request_types)
                ...
                ->addColumn('action', (function($value){
                        return '<button type="button" class="btn btn-warning btn-sm waves-effect waves-light" title="Edit Request Type" onclick=REQUEST_TYPE.show('.$value->id.')><i class="fas fa-pencil-alt"></i></button>
