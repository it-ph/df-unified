            ...
            <div class="card-body">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-sm nowrap w-100">
                        ...
                        <tr>
                            <td class="col-sm-2 fw-bold">Client Name</td>
                            <td class="col-sm-10">{{ $job['client'] }}</td>
                        </tr>
                        @endif
                        <tr>
                        ...
                        <tr>
                            <td class="col-sm-2 fw-bold">Designer</td>
                        ...
                        <tr>
                            ...
                            <td class="col-sm-10 tdbreak"><a href="{{ $job['salesforce_link'] }}" rel="noopener noreferrer" target="_blank" class="text-info">{{ $job['salesforce_link'] }}</a></td>
                        </tr>
                        <tr>
