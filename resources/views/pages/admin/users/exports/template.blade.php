<table>
    ...
    <tr>
        ...
        <th style="width: 200px; text-align: center; background-color: #00599D; color: white">supervisor_email</th>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="3" style="color: red; font-weight: bold"> Note: Roles must be separated by a comma. E.g. Manager,Supervisor,Proofreader,Designer</td>
        </tr>
    </tbody>
</table>
